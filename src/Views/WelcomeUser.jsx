        ...
        <div class="container">
          <div class="flex justify-between">
            <div class="w-full text-center">
              <h2 class="text-4xl font-bold leading-snug text-dark-blue mb-10 wow fadeInUp" data-wow-delay="1s">This is a Page that  user can see
                <br class="hidden lg:block" />But admin cant see </h2>
              ...
              <div class="text-center wow fadeInUp" data-wow-delay="1.6s">
                <img class=" mx-auto h-96 w-96" src="/images/user1.png" alt="" />
              </div>
            </div>
          </div>
        </div>
